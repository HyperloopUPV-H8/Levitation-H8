...
MODEL                = H8_1GDL_Lineal_sensor
MODULES              = H8_1GDL_Lineal_sensor_acc.c H8_1GDL_Lineal_sensor_acc_data.c c_mexapi_version.c lccstub.c
PRODUCT              = $(RELATIVE_PATH_TO_ANCHOR)/H8_1GDL_Lineal_sensor_acc.mexw64
MAKEFILE             = H8_1GDL_Lineal_sensor.mk
MATLAB_ROOT          = C:/Program Files/MATLAB/R2022b
ALT_MATLAB_ROOT      = C:/PROGRA~1/MATLAB/R2022b
START_DIR            = C:/Users/ramuj/Desktop/HYPERL~1/H8/LEVITA~1/LEVITA~1/MODELO~2/1GDL~1
S_FUNCTIONS_LIB      = 
NUMST                = 2
NCSTATES             = 9
...
MODELLIB                  = H8_1GDL_Lineal_sensor_acc.mexw64
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = H8_1GDL_Lineal_sensor_ref.rsp
...
ADD_INCLUDES = \
	-I$(START_DIR) \
	-I$(START_DIR)/slprj/accel/H8_1GDL_Lineal_sensor \
...
H8_1GDL_Lineal_sensor_acc.obj : $(START_DIR)/slprj/accel/H8_1GDL_Lineal_sensor/H8_1GDL_Lineal_sensor_acc.c
	$(CC) -c -Fo$(@F) $(CFLAGS) $(START_DIR)/slprj/accel/H8_1GDL_Lineal_sensor/H8_1GDL_Lineal_sensor_acc.c

H8_1GDL_Lineal_sensor_acc_data.obj : $(START_DIR)/slprj/accel/H8_1GDL_Lineal_sensor/H8_1GDL_Lineal_sensor_acc_data.c
	$(CC) -c -Fo$(@F) $(CFLAGS) $(START_DIR)/slprj/accel/H8_1GDL_Lineal_sensor/H8_1GDL_Lineal_sensor_acc_data.c
